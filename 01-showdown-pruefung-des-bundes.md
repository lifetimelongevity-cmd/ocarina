# Prüfung 5: Showdown "Prüfung des Bundes"

**Ort:** Gipfel Neureuth (Wiese vor dem Berggasthaus, nicht auf dem Weg).
**Dauer:** 25 bis 35 Minuten.
**Zweck im System:** Hier wird eingelöst, was Dennis über den Tag gesammelt oder verloren hat. Jedes Item hat im Showdown genau eine definierte Wirkung (siehe §5). Wer ein Item baut, das hier nichts tut, baut es falsch.
...
> "Du hast uns durch den Tag geschleift, Dennis. Jetzt stehen wir hier oben und du willst gehen. Der Bund lässt niemanden ziehen, der ihn nicht besiegt hat. Drei Duelle. Wähl deine Waffen."

---

## 2. Aufbau

- Die Wächter stehen im Halbkreis, Dennis gegenüber.
- In der Mitte liegt das **Bund-Deck**: sechs verdeckte Disziplin-Karten (siehe §3).
- Der Spielleiter liest Dennis' **Inventar** laut vor. Was er hat, was er verloren hat, was er sich hätte holen können. Das ist der Moment, in dem das Roguelike-Prinzip für alle sichtbar wird.
- Berry-Stand (siehe `02-items-und-oekonomie.md`) wird laut gesagt.

---

## 3. Das Bund-Deck (Disziplinen)

Sechs Karten, drei werden gezogen. Jede Disziplin ist in unter drei Minuten auf einer Gipfelwiese spielbar und braucht nur Material aus der Packliste.

| Karte | Disziplin | Regel | Item, das hier wirkt |
|---|---|---|---|
| A | **Schnick Schnack Schnuck** | Best of 3, klassisch. | Steckbrief (verrät, womit der Gegner immer eröffnet) |
...
## 4. Ablauf der drei Duelle

Pro Duell, immer in dieser Reihenfolge:

1. **Ziehen.** Der Spielleiter deckt die oberste Karte des Bund-Decks auf. Alle sehen die Disziplin.
2. **Der Bund nominiert.** Der Bund berät kurz (max. 30 Sekunden) und schickt seinen besten Wächter für diese Disziplin. Der Bund darf jeden Wächter nur einmal im Showdown einsetzen.
3. **Dennis reagiert.** Jetzt und nur jetzt darf Dennis Items einsetzen (Reihenfolge frei, jedes Item pro Showdown einmal, sofern nicht anders angegeben):
   - **Schwert der Verdammnis**: Der nominierte Wächter wird gestrichen. Der Bund muss einen anderen schicken. Einmal pro Duell einsetzbar, also potenziell in allen drei Duellen.
   - **Herausforderungs-Token**: Dennis tritt nicht selbst an, sondern zwingt einen Wächter, für ihn zu kämpfen. Sein Sieg zählt als Dennis' Sieg. Der gewählte Wächter darf nicht der nominierte sein und ist danach für den Bund verbraucht.
   - **Steckbrief**: Darf jederzeit gelesen werden, ist Wissen, kein Einsatz.
4. **Duell.** Nach Regel der Karte.
5. **Schild des Bundes** (falls vorhanden): Wird nach einem verlorenen Duell eingesetzt. Das Duell wird sofort mit gleicher Disziplin und gleichem Gegner wiederholt. Einmal pro Showdown. Das Schild ist danach zerbrochen.
6. Ergebnis wird auf der Tafel notiert (Kreide auf dem Kästchen-Deckel oder Notizbuch).

Falls der Bund das Token gegen Dennis hält (weil er das blinde Duell verloren hat): Der Bund darf einmal im Showdown die gezogene Disziplin-Karte zurücklegen und eine neue ziehen, nachdem Dennis seine Items gesetzt hat. Das ist die Spiegelung von "Dennis darf jemanden zwingen".

---

## 5. Item-Wert im Showdown (die eigentliche Tabelle)

Diese Tabelle ist der Vertrag zwischen Tag und Finale. Jedes Item, das es im Spiel gibt, steht hier mit seiner Wirkung. Was hier nicht steht, hat im Showdown keinen Effekt und muss seinen Wert woanders haben (Kästchen, Encounter) oder gestrichen werden.

| Item | Woher | Wirkung im Showdown | Stärke |
|---|---|---|---|
| Schwert der Verdammnis | Encounter-Pool (Duell-Karte gewonnen) oder Auge des Jägers mit 5 Treffern | Pro Duell einen nominierten Wächter streichen | hoch, wirkt in jedem Duell |
| Herausforderungs-Token | Blindes Duell gewonnen | Ein Duell von einem Wächter seiner Wahl austragen lassen | hoch, faktisch ein Duell mit dem besten Spieler des Bundes |
| Große Wasserpistole | Encounter-Pool (Geschicklichkeits-Karte) | Wasserduell fast sicher gewonnen | hoch, aber nur zu 50 % relevant |
| Großer Ring | Encounter-Pool (Geschicklichkeits-Karte) | Ringwurf deutlich leichter | mittel |
...
Nach drei Duellen zählt der Spielleiter.
...
## 7. Warum diese Struktur (Design-Notizen)

- **Disziplin zuerst, dann Gegner.** Umkehrung des blinden Duells von Prüfung 3. Dort wählte Dennis den Gegner blind, hier sieht er die Disziplin, aber der Bund wählt den Gegner. Das Schwert ist deshalb genau hier stark: Es nimmt dem Bund seine beste Antwort.
- **Jeder Wächter nur einmal.** Sonst schickt der Bund dreimal den sportlichsten. Dennis' Schwert und Token werden dadurch zu echten Ressourcenentscheidungen.
...
## 8. Spielleiter-Karte (zum Ausdrucken)

```
PRÜFUNG DES BUNDES, Gipfel
[ ] Halbkreis, Bund-Deck gemischt und verdeckt
[ ] Inventar laut vorlesen, Berry-Stand nennen
[ ] Eröffnungssatz
Duell 1: Karte ___  Bund schickt ___  Items: ___  Sieger: ___
Duell 2: Karte ___  Bund schickt ___  Items: ___  Sieger: ___
