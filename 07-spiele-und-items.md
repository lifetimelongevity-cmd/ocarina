...
| Nr. | Punkt | Stand |
|---|---|---|
| B1 | Wurfspiele doppeln sich | Durch 12 Schwertwurf und 9 als Duell entschärft |
| B2 | Schnick Schnack Schnuck dreifach | Erledigt: nirgends Topf oder Deck (25.09.), alles bekommt einen festen Platz in einer klaren Linie |
| B3 | Grenze für „bestanden" | Später, Quest Master entscheidet frei |

## Items (helfen im jeweiligen Spiel selbst)
...
6 Prophezeiung und 15 Rikes Amulett laufen den ganzen Tag neben der festen Reihenfolge. Die App kennt bisher nur eine Reihe, in der immer die erste offene Quest dran ist. Für diese beiden braucht es einen eigenen Bereich „Läuft" (sichtbar, sobald gestartet) und für die Prophezeiung einen Zähler statt bestanden oder verloren.

**Übrig (25.09.):** 1 Log-Buch, 2 Auge des Jägers, 3 Feuerprobe, 4 Kreuzung der Klingen, 5 Showdown, 6 Prophezeiung (läuft), 7 Podrennen, 9 Kartenwurf, 12 Klingen des Deku-Baums, 14 Wirbel der Götter, 15 Rikes Amulett (läuft).
