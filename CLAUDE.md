...
2. Log-Buch: Die 6 Fragen stehen (26.09., Rike antwortet über Dennis, er errät ihre Antwort in ein bis drei Worten). Liste für Rike in `app/assets/logbuch/LIESMICH.md`. An Rike schicken, Sprachnachrichten als `app/assets/logbuch/frage1.m4a` bis `frage6.m4a` ablegen.
