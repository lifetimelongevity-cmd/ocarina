...
| `app/assets/intro-wald.jpg`, `triforce.woff2`, `hylia-serif.woff2`, `hylian-symbols.woff2`, `SCHRIFTEN.md` | Hintergrund des Startbildschirms (Cover des Nutzers, Logo, Link und Fee mit LaMa entfernt, Seiten ergänzt) und die Zelda-Schriften von zeldauniverse.net: Triforce für DENNIS, Hylia Serif für die kleinen Zeilen, Hylian Symbols als Quelle für Wappen und Medaillon-Zeichen. Fan-Schriften, nur privat und nicht kommerziell, Details in `SCHRIFTEN.md` |
